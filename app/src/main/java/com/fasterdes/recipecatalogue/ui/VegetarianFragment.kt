...
import com.fasterdes.recipecatalogue.databinding.FragmentVegetarianBinding

class VegetarianFragment : Fragment() {

    private var binding : FragmentVegetarianBinding? = null // Keadaan binding msih kosong dari fragment akan disi di onCreateView
