...
import com.fasterdes.recipecatalogue.databinding.FragmentBreakfastBinding

class BreakfastFragment : Fragment() {

    private var binding : FragmentBreakfastBinding? = null // Keadaan binding msih kosong dari fragment akan disi di onCreateView
