package com.fasterdes.recipecatalogue.data
...
object DataRecipes {
    ...
    private val numberBreakfast = arrayOf(
        "10 K",
        "20 K",
        "1 K",
        "2 K",
    ...
    private val numberDessert = arrayOf(
        "200 K",
        "340 K",
        "200 K",
        "26 K",
    ...
    private val numberVegetarian = arrayOf(
        "20 K",
        "30 K",
        "20 K",
        "26 K",
    ...
    val listBreakfast: ArrayList<Recipes>
        ...
        get() {
            ...
            for (data in numberBreakfast.indices) { // indices rentang jarak array dalam index number
                val recipe = Recipes(
            ...
            return list // Mengisi kekosongan dari arrayListOf
        }
    ...
    val listDessert: ArrayList<Recipes>
        ...
        get() {
            ...
            for (data in numberDessert.indices) { // indices rentang jarak array dalam index number
                val recipe = Recipes(
